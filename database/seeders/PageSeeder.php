    ...
    public function run(): void
    {
        $pages = [
            [
                ...
                'body' => ['en' => '<p>DOBERO HOME CREATOR supports international buyers with property sourcing, relocation guidance, construction planning, and trusted local insight across Spain.</p>', 'es' => '<p>DOBERO HOME CREATOR apoya a compradores internacionales con búsqueda de propiedades, asesoramiento en reubicación, planificación de construcción y experiencia local.</p>', 'hu' => '<p>A DOBERO HOME CREATOR támogatja a nemzetközi vásárlókat ingatlankereséssel, költözési tanácsadással és helyi szakértelemmel Spanyolországban.</p>'],
                'meta_title' => ['en' => 'About DOBERO', 'es' => 'Sobre DOBERO', 'hu' => 'A DOBERO-ról'],
                'meta_description' => ['en' => 'Learn about DOBERO HOME CREATOR and its real estate, relocation, and construction services in Spain.', 'es' => 'Conozca DOBERO HOME CREATOR y sus servicios inmobiliarios, de reubicación y construcción en España.', 'hu' => 'Ismerje meg a DOBERO HOME CREATOR ingatlanos, költözési és építési szolgáltatásait Spanyolországban.'],
                'sort_order' => 1,
                'deletable' => false,
            ],
            [
                ...
                'meta_description' => ['en' => 'Get in touch with DOBERO HOME CREATOR.', 'es' => 'Póngase en contacto con DOBERO HOME CREATOR.', 'hu' => 'Vegye fel a kapcsolatot a DOBERO HOME CREATOR csapatával.'],
                'sort_order' => 2,
                'deletable' => false,
            ],
            [
